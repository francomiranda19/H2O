...
func fire():
	var soldier_bullet = SoldierBullet.instance()
	get_parent().add_child(soldier_bullet)
	soldier_bullet.global_position = $Bullet.global_position
	soldier_bullet.rotation = (_target.global_position - global_position).angle()
